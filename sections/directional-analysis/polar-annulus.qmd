...
polarAnnulus(mydata, pollutant = "pm10", period = "trend", title = "Trend")

polarAnnulus(mydata, pollutant = "pm10", period = "season", title = "Season")

polarAnnulus(mydata, pollutant = "pm10", period = "weekday", title = "Weekday")

polarAnnulus(mydata, pollutant = "pm10", period = "hour", title = "Hour")
```
...
#| eval: false
## wind speed >2
polarAnnulus(filter(mydata, ws > 2), pollutant = "pm10", type = "hour")
