...
```{r}
#| label: loadCMAQ
load(url("https://github.com/openair-project/book/raw/refs/heads/main/assets/data/CMAQozone.RData"))
...
```{r}
#| echo: false
load(url("https://github.com/openair-project/book/raw/refs/heads/main/assets/data/condDat.RData"))
```
