...
```
In @fig-importAQdata the y-scale is the same by default for all panels. However, the `y.relation` argument can be used to set the y-scales to be set individually for each panel by setting `y.relation = "free"`. 
