...
The simplest use of `WhittakerSmooth()` is to produce a smoothed version of a pollutant time series. In the example below, NO~2~ concentrations are smoothed with `lambda = 20`. The function adds a new column `smooth_no2` to the data frame.
