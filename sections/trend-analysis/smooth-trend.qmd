...
smoothTrend(
  ...
  deseason = TRUE,
  ylab = "concentration (ppb)",
  title = "monthly mean deseasonalised o3"
)
...
smoothTrend(
  ...
  simulate = TRUE,
  ylab = "concentration (ppb)",
  title = "monthly mean no2 (bootstrap uncertainties)"
)
...
smoothTrend(
  ...
  simulate = TRUE,
  ylab = "concentration (ppb)",
  title = "monthly mean deseasonalised no2 (bootstrap uncertainties)"
)
```
...
#| fig-width: 10
#| fig-height: 12
smoothTrend(mydata, pollutant = "o3", deseason = TRUE, type = "wd")
```
