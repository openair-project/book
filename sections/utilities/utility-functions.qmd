...
: Default temporal decomposition produced by `kzFilter()` for hourly data. {#tbl-kz-components}
...
timePlot(kz_out_o3, pollutant = "seasonal", 
...
- There is a wish to detect and locate undocumented discontinuities.
